    ...
    <div class="container">
        ...
        <div id="section-top-metrics" class="section-block" style="border-top: none; margin-top: 3rem; padding-top: 0;">
            ...
            <p class="section-desc" style="margin-bottom: 2rem; text-align: left; background: #f8fafc; padding: 1.5rem; border-radius: 8px; border-left: 4px solid var(--accent-blue);">
                ...
                <strong>Architecture Note:</strong> Similar to the LOTA configuration, this MLEP implementation uses a <strong>completely unfrozen ResNet-50 backbone</strong>, computing full gradients across all <strong>23.5 million parameters</strong> during training to maximize feature extraction from the 2x2 local entropy patches.<br><br>
