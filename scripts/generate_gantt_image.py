...
# Title and subtitle
plt.title("LOTA Steganalysis Project: 3-Week Engineering Sprint Schedule\n(28 July 2026 – 18 August 2026)", 
...
output_path = "/Volumes/Seagate/JIO TERM/JIO-TERM 3/DL AND CV PROJECT/LOTA_Gantt_Chart.png"
